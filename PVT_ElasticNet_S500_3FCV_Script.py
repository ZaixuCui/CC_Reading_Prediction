...
# The .mat files in this script should be generated by Matlab
# For example, the GMV_Fold12_training_All_PicVocab.mat should contain one variable named 'GMV_Fold12_training_All_PicVocab', 
# it's a m*n matrix with m is number of subjects of Fold1&2, n is the feature quantity
# PicVocab_AgeAdj_All_Index_Sorted.mat is a .mat file with several m*1 vectors, m is the number of subjects, for example, it 
# contains variable Fold1_PicVocab_AgeAdj (169*1 double), Fold2_PicVocab_AgeAdj (169*1 double), Fold3_PicVocab_AgeAdj (169*1 
# double), Fold12_PicVocab_AgeAdj (338*1 double), Fold13_PicVocab_AgeAdj (338*1 double), Fold23_PicVocab_AgeAdj (338*1 double)
