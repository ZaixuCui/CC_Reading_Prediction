...
# For example, the PicVocab_AgeAdj_S500_All.mat should contain one variable named 'PicVocab_AgeAdj_S500_All', it's a m*n 
# matrix with m is number of subjects of Fold1&2, n is the feature quantity
# PicVocab_AgeAdj_S500_All.mat is a .mat file that contains one variable named 'PicVocab_AgeAdj_S500_All', it's a 507*1
# vectors, 507 is the number of subjects
