...
CZ_ElasticNet_Revise.ElasticNet_APredictB_Permutation(GMV_S500_All_training, PicVocab_AgeAdj_S500_All, GMV_S900New_All_testing, \
    PicVocab_AgeAdj_S900New_All, np.arange(1000), np.exp(np.linspace(-6,5,20)), np.linspace(0.2, 1, 10), 3, ParentFolder + '/Permutation2', 1, 600, '-q short -l nodes=1:ppn=1')     
